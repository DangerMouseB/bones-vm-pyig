module bones.pyig.scanning;       // adapted from autowrap:pyd
...
/**
   ...
   bones.pyig.boilerplate.pydBoilerplate.
 */
...
import bones.pyig.awtypes : isModule;
...
import bones.pyig.wrappers : OpCall, OpSliceAssign, Def, OpSlice, Len, OpIndex, OpIndexAssign, StaticDef, Property,
...
private template Operators(T, string opName) {
    static if(hasMember!(T, opName)) {
        ...
        mixin(`import bones.pyig.wrappers: ` ~ pydName ~ `;`);
